...
export function CreateCategoryModal({
  ...
  const hasRemainingCategory = existingCategories.some(
    (c) => c.allocationMethod === "REMAINING",
  );
  ...
  const allocationOptions = [
    ...
    { value: "PERCENTAGE", label: "Percentage of Budget" },
    {
      ...
      disabled: hasRemainingCategory,
    },
  ];

  return (
    <Modal opened={opened} onClose={onClose} title="Create Category" size="md">
